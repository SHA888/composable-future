...
\subsection{OP3: Correct Equivalence Relation Between Futures}

Bisimulation is standard in process algebra. Is strong bisimulation, weak bisimulation, or a new paradigm-specific equivalence appropriate for composable futures? (Unresolved.)
...
The codebase is available at \url{https://github.com/SHA888/composable-future} with all proofs verified in Lean 4.
